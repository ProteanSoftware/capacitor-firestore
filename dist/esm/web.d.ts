...
import type { CallbackId, CapacitorFirestorePlugin, CollectionSnapshot, CollectionSnapshotCallback, CollectionReference, CustomToken, DocumentSnapshot, DocumentSnapshotCallback, DocumnentReference, FirestoreConfig, RemoveSnapshotListener, UpdateDocument } from './definitions';
